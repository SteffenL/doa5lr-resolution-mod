#include "ViewportPatch.hpp"
#include "../common/util.hpp"

#include <Windows.h>

class ViewportPatch::Impl {
public:
    Impl(const Process& process) {
...
ViewportPatch::ViewportPatch(const Process& process) : m_impl{std::make_unique<Impl>(process)} {}
