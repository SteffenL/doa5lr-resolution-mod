...
class AspectRatioPatch::Impl {
public:
    Impl(const Process& process, const Config& config) {
...
AspectRatioPatch::AspectRatioPatch(const Process& process, const Config& config)
    : m_impl{std::make_unique<Impl>(process, config)} {}

AspectRatioPatch::~AspectRatioPatch() {}
